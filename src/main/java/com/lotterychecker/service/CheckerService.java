...
public class CheckerService {
	...
	if (forceCheck || game != null && apiResultVO.getDrawNumber() != null && game.getLastDraw().compareTo(apiResultVO.getDrawNumber()) == -1) {
	    ;
		...
		if (checkedResults.size() == 1) {
		    ...
		    message.append("Draw result: " + checkedResult.getHits() + Constants.LINE);
